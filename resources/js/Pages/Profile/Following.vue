...
<template>
    <Head :title="`${profileUser.name}'s Following`" />
    ...
    <AuthenticatedLayout>
        <div class="max-w-2xl mx-auto py-8 px-4">
            ...
            <!-- Heading -->
            <h1 class="text-2xl font-bold text-gray-900 mb-1">{{ profileUser.name }}'s Following</h1>
            ...
            <div v-if="users.length === 0" class="text-center text-gray-500 mt-16">
                ...
                <Link
                    ...
                    class="inline-block mt-4 bg-indigo-600 text-white rounded-full px-6 py-2 text-sm hover:bg-indigo-700 transition"
                >
                    Find Readers
                </Link>
            </div>
