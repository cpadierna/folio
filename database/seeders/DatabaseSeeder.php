    ...
    public function run(): void
    {
        DB::transaction(function () {
            ...
            foreach ($userIds as $userId) {
                $count   = fake()->numberBetween(3, 25);
                $sampled = fake()->randomElements($bookIds, min($count, count($bookIds)));
            ...
            foreach ($userIds as $userId) {
                ...
                $targets = fake()->randomElements($others, min($count, count($others)));
            ...
            foreach ($userIds as $userId) {
                ...
                $sampled = fake()->randomElements($bookLogIds, min($count, count($bookLogIds)));
            ...
            $commentTargets = fake()->randomElements(
                $bookLogIds,
            ...
            foreach ($commentTargets as $bookLogId) {
                ...
                $commenters   = fake()->randomElements($userIds, min($commentCount, count($userIds)));
